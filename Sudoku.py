...
screen.title("Noura's & Ayman's Project")
screen.tracer(0)
...
def welcome_screen():
    ...
    pen2.clear()
    pen.goto(-210, 50)
    pen.write('SUDOKU' , font = ('Arial', 55, 'normal'))
    pen.goto(-330, 200)
    pen.write('Welcome To Our Project' , font = ('Arial', 50, 'normal'))
    pen.goto(-95, -0)
    rect(pen, 200, 75)
    pen.goto(-95, -100)
    rect(pen, 200, 75)
    ...
    pen.goto(15, -270)
    pen.write('Realised by: Noura & Ayman' , font = ('Arial', 20, 'normal'))
